...
class AgentDB:
    ...
    async def create_task(
        self, input: Optional[str], additional_input: Optional[dict] = None
    ) -> Task:
        if self.debug_enabled:
    ...
    async def create_step(
        ...
        try:
            ...
            LOG.error(f"NotFoundError while creating step: {e}")
            raise
        except Exception as e:
    ...
    async def create_artifact(
        ...
        try:
            ...
            LOG.error(f"NotFoundError while creating artifact: {e}")
            raise
        except Exception as e:
            LOG.error(f"Unexpected error while creating step: {e}")
            raise
