...
class PolyDatabase(AgentDB):
    ...
    async def add_chat_message(self, task_id, role, content):
        ...
        try:
            ...
            LOG.error(f"NotFoundError while creating task: {e}")
            raise
    ...
    async def get_chat_history(self, task_id):
        ...
        try:
            ...
            LOG.error(f"NotFoundError while getting chat history: {e}")
            raise
        except Exception as e:
    ...
    async def create_action(self, task_id, name, args):
        try:
            ...
            LOG.error(f"NotFoundError while creating action: {e}")
            raise
        except Exception as e:
    ...
    async def get_action_history(self, task_id):
        ...
        try:
            ...
            LOG.error(f"NotFoundError while getting action history: {e}")
            raise
        except Exception as e:
